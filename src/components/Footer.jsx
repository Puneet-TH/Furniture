        ...
        <div className='text-amber-50'>
          ...
          <ul className="space-y-3 text-base opacity-90">
            <li className="flex items-start gap-2">
              ...
              <span>Plot No. 367, Industrial Area<br/>Phase 1, Panchkula<br/>Haryana, India 134113</span>
            </li>
            ...
            <li className="flex items-center gap-2">
              ...
              <span>anzerfurniture@gmail.com</span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-amber-700">
                {/* Clock icon */}
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="#" className="hover:text-amber-700 underline">View Directions in Google Map</a>
            </li>
          </ul>
        </div>
      </div>
